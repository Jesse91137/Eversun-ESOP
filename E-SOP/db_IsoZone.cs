...
namespace E_SOP
{
    static class db_IsoZoen
    {
        ...
        public static SqlConnection GetCon()
        {
            ...
            //string cnstr = "server=ACLFWLOG;database=TWM8;uid=TWM8Sa;pwd=twm8$@523;Connect Timeout = 10";
            string cnstr = "server=qazone;database=isozone_db;uid=esop_user;pwd=avalue@esopuser;Connect Timeout = 10";
        ...
        {
            SqlConnection con = db_IsoZoen.GetCon();//連接資料庫
            //con.Open();
        ...
        {
            SqlConnection con = db_IsoZoen.GetCon();
