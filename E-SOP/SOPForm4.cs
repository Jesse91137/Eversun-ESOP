...
{
    /// <summary>
    /// SOPForm4 表單，負責顯示 SOP PDF，並根據 INI 設定調整視窗行為。
    /// </summary>
    public partial class SOPForm4 : Telerik.WinControls.UI.RadForm
    {
        /// <summary>
        /// 靜態實例計數器，用於追蹤 SOPForm4 實例數量。
        /// </summary>
        ...
        /// <summary>
        /// SOPForm4 載入事件，根據 INI 設定調整視窗位置與載入 PDF。
        /// </summary>
        ...
        private void SOPForm4_Load(object sender, EventArgs e)
        {
            ...
            if (Double == "ON")
            {
                ...
                axAcroPDF4.src = System.Windows.Forms.Application.StartupPath + "\\" + "Temp" + "\\" + SOPName; // 載入 PDF
            }
            else
            {
                axAcroPDF4.src = System.Windows.Forms.Application.StartupPath + "\\" + "Temp" + "\\" + SOPName; // 載入 PDF
        ...
        private void SOPForm4_Shown(object sender, EventArgs e)
        {
            ...
            {
                this.WindowState = FormWindowState.Maximized; // 單螢幕最大化
            }
        }
    }
}
